...
prompt_anaconda() {
  ...
  if ! [ -z "$_path" ]; then
    ...
    "$1_prompt_segment" "$0" "$2" "fuchsia" "$DEFAULT_COLOR" "$(basename $_path)" 'PYTHON_ICON'
  fi
}
...
#set_default POWERLEVEL9K_SHORTEN_STRATEGY "truncate_to_first_and_last"
...
prompt_powerlevel9k_setup() {
  ...
  defined POWERLEVEL9K_LEFT_PROMPT_ELEMENTS || POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon anaconda ssh user dir vcs dir_writable status root_indicator background_jobs)
  #defined POWERLEVEL9K_LEFT_PROMPT_ELEMENTS || POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon anaconda ssh dir vcs dir_writable newline user)
  defined POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS || POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=()
  #defined POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS || POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status root_indicator background_jobs)
  #defined POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS || POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time root_indicator anaconda background_jobs history time)
